...
function Modal({ children, open, onClose, style, backdrop }) {
    ...
    return (jsxRuntime.jsx("dialog", { ref: dialogRef, className: "modal", style: { ...style, "--backdrop-opacity": opacity }, children: open && (jsxRuntime.jsxs("div", { children: [jsxRuntime.jsx("button", { onClick: onClose, className: "modal-close-button", children: jsxRuntime.jsx("span", { className: "material-symbols-outlined", children: "close" }) }), children] })) }));
}
...
function DarkModeButton() {
    ...
    return (jsxRuntime.jsx("button", { onClick: toggleDarkMode, className: "dark-mode-toggle", children: jsxRuntime.jsx("span", { className: `material-symbols-outlined ${isDarkMode ? "dark-mode-button" : "light-mode-button"}`, children: "dark_mode" }) }));
}
...
const Dropdown = ({ menu, onSelect, placement = "bottomLeft", children }) => {
    ...
    return (jsxRuntime.jsxs("div", { ref: dropdownRef, className: "dropdown-container", children: [jsxRuntime.jsx("div", { onClick: () => setIsOpen(prev => !prev), style: { cursor: "pointer" }, children: children }), isOpen && (jsxRuntime.jsx("ul", { ref: menuRef, className: `dropdown-menu ${placement}`, style: {
                    top: placement === "topLeft" || placement === "topRight"
                        ? `-${menuHeight}px`
                        : undefined
                }, children: menu.map(item => (jsxRuntime.jsx("li", { className: "dropdown-item", onClick: () => handleMenuClick(item), children: item.label }, item.key))) }))] }));
};
...
function LoaderBasic() {
    return (jsxRuntime.jsxs("div", { className: "loader", children: [jsxRuntime.jsx("div", { className: "circle" }), jsxRuntime.jsx("div", { className: "circle" }), jsxRuntime.jsx("div", { className: "circle" })] }));
}
...
function LoaderFullScreen() {
    return (jsxRuntime.jsx("section", { className: "loader-dim", children: jsxRuntime.jsxs("div", { className: "loader", children: [jsxRuntime.jsx("div", { className: "circle" }), jsxRuntime.jsx("div", { className: "circle" }), jsxRuntime.jsx("div", { className: "circle" })] }) }));
}
...
const showMessage = (content, type) => {
    ...
    if (!messageContainer) {
        ...
        ReactDOM.render(jsxRuntime.jsx(MessageHandler, {}), messageContainer);
...
const MessageHandler = () => {
    ...
    return (jsxRuntime.jsx("div", { className: "message-container", role: "alert", children: messages.map(message => (jsxRuntime.jsxs("div", { className: `message ${message.type} display-flex`, children: [jsxRuntime.jsx("span", { className: "material-symbols-outlined icons", children: message.type }), jsxRuntime.jsx("p", { children: message.content })] }, message.id))) }));
};
const Message = {
    info: (content) => {
...
function ScrollNavigation({ items, top = 0, backgroundColor, textColor }) {
    ...
    return (jsxRuntime.jsx("nav", { className: "scroll-navigation", style: { top }, children: jsxRuntime.jsx("ul", { className: "scroll-navigation-container", children: items.map(item => (jsxRuntime.jsx("li", { className: "scroll-navigation-item", id: `nav-${item}`, onClick: () => navClickHandler(item), children: item }, item))) }) }));
}
...
exports.Modal = Modal;
exports.ScrollNavigation = ScrollNavigation;
